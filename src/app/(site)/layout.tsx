          ...
          {isVwoSyncPage && (
            <>
              <script
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    "window.startTime=performance.now();window.startTimeTs=Date.now();",
                }}
              />
              <script
                nonce="456723789323765435"
